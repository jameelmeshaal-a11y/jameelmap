...
## المرحلة 4 — الإطلاق والمراقبة

### 4.1 اختبار Playwright — ⏸️ مؤجّل لاكتمال الدفع
### 4.2 مراجعة الأمان — ✅ تم
- HIBP مُفعّل، disable_signup مُفعّل، صفحة `/privacy` مُضافة.
- 3 تحذيرات SECURITY DEFINER (has_role/get_user_role/has_any_admin) مُتعمَّدة لاستخدامها في سياسات RLS.

### 4.3 GA4 — ⏸️ ينتظر مُعرّف GA4 من العميل (G-XXXXXXX)
### 4.4 صفحات التسويق — ⏸️ مؤجّل (تُكمل مع اكتمال الدفع)
...
| 2.1 جداول الباقات | ✅ |
| 2.2 `/pricing` | ✅ |
| 2.3 بوابة دفع | ⏸️ ينتظر قرار العميل |
| 2.4 تقييد الاستخدام | ✅ |
| 3.1 سوشيال | ✅ |
| 3.2 إشعارات بريد | ⏸️ يتطلب من العميل تكوين نطاق البريد |
| 3.3 Indexes | ✅ |
| 4.2 أمان + privacy | ✅ |
| 4.3 GA4 / 4.1 / 4.4 | ⏸️ |
